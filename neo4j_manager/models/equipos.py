...
SET equipo.nombre = toString(record.nombre),
    ...
    equipo.fecha_actualizacion = toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
    privilegio.fecha_actualizacion = toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
...
CREATE (equipo:EquipoEmpresa {
    ...
    empresa_id_old: '',
    equipo_id_old: '',
    fecha_actualizacion: toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
...
CREATE (saldo:SaldoEquipo {
    ...
    fecha_actualizacion: toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
    fecha_creacion: toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
    fecha_fin: toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
    fecha_inicio: toString(datetime.truncate('second', datetime({timezone:'America/Bogota'}))),
